...
const shoppingOrderSlice= createSlice({
    ...
    extraReducers:(builder)=>{
        builder.addCase(createNewOrder.pending,(state)=>{
            ...
            state.approvalURL=action.payload.approvalURL //from controllers- payment-paypal-create fxn
            state.orderId=action.payload.orderId
            sessionStorage.setItem('currentOrderId',JSON.stringify(action.payload.orderId))  // to save orderId in sessionstorage
