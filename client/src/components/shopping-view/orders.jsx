...
function ShoppingOrders() {
    ...
    const {user}=useSelector((state) => state.auth)  //for user Id to dispatch getAllOrdersByUserId -to get orders
    const {orderList,orderDetails}=useSelector((state) => state.shopOrder)  //to get order details or list
    ...
    useEffect(()=>{
        dispatch(getAllOrdersByUserId(user?.id))  //this should get orders
    },[dispatch])
